...
\begin{experience}{Principal Architect}{Bankbazaar.com}{2019-Present, Bangalore}{%
  ...
  \begin{experiencebullets}
    ...
    \expmultibullet {Team Leadership \& Mentoring}{Cultivated a high-performing engineering culture and fostered talent development}
    {
      \aexpbullet {Formally managed a team of 4 engineers, providing guidance and support for their professional growth}
      {Ensured alignment with organizational goals and individual career aspirations}
      \aexpbullet {Informally mentored 10+ engineers, sharing expertise in cloud architecture, DevOps, and best practices}
      {Accelerated skill development and fostered a collaborative learning environment}
      \aexpbullet {Led the hiring process for formal reports, including interviewing and selection}
      {Successfully attracted and onboarded top-notch engineering talent}
      \aexpbullet {Conducted informal performance feedback sessions and guided career progression}
      {Empowered engineers to make independent decisions and achieve recognition}
    }

    \expmultibullet {Devops}{Built Scalable Infrastructure, Observability, and Incident Automation}
    {
      \aexpbullet {Directed the definition of microservice architecture standards and deployment patterns for seamless self-service of engineering requirements}
      {New service onboarding time reduced from 2 days to < 1 hour}
      
      \aexpbullet {Oversaw standardization of observability across all services by enforcing logging, alerting and metrics contracts}
